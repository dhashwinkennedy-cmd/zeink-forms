              ...
              {currentPage.fields.map((field) => (
                <div key={field.id} className="space-y-4">
                  ...
                  {field.type === 'MCQ' ? (
                    ...
                    <textarea 
                      className="w-full px-5 sm:px-8 py-4 sm:py-6 bg-[#F8F9FA] rounded-xl sm:rounded-[1.5rem] outline-none font-bold text-sm sm:text-base min-h-[120px] sm:min-h-[150px] resize-none border-2 border-transparent focus:border-[#ff1a1a]/10 focus:bg-white transition-all"
                    ...
                    <input 
                      type="text"
                      className="w-full px-5 sm:px-8 py-3.5 sm:py-5 bg-[#F8F9FA] rounded-xl sm:rounded-[1.5rem] outline-none font-bold text-sm sm:text-base border-2 border-transparent focus:border-[#ff1a1a]/10 focus:bg-white transition-all"
                      value={getAnswerValue(field.id)}
                      onChange={(e) => handleUpdateAnswer(field.id, e.target.value, 0)}
                      placeholder="Answer..."
                    />
